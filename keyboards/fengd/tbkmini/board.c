...
static board_interface_t master_interface = {board_select_master_row, board_unselect_master_row, board_unselect_master_rows, board_read_cols_on_master_row};
static board_interface_t slave_interface  = {board_select_slave_row, board_unselect_slave_row, board_unselect_slave_rows, board_read_cols_on_slave_row};
...
static void board_select_slave_row(board_info_t* board, uint8_t board_row) {
    ...
    uint8_t iodir  = PIN2MASK(pin);
    uint8_t status = PIN2MASK(pin);
