...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_split_3x6_3(
      ...
      KC_LGUI, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,              KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RGUI,
                                 RAISE, LCTL_T(KC_SPC),  KC_CAPS,             KC_DEL, KC_ENT, LOWER
    ),
    ...
    [_RAISE] = LAYOUT_split_3x6_3(
      ...
      _______, _______, _______, _______, _______, _______,           KC_TILD,KC_PLUS, KC_MINS, KC_LBRC, KC_RBRC, KC_PIPE,
      _______, _______, _______, _______, _______, _______,           KC_GRV,KC_EQL, KC_UNDS, KC_LCBR, KC_RCBR, KC_BSLS,
                                  _______, _______, _______,            _______, _______, ADJUST
    ),

    [_ADJUST] = LAYOUT_split_3x6_3(
      QK_BOOT, _______,   _______, _______, _______, KC_MUTE,           _______, _______,   _______, _______, _______, _______,
